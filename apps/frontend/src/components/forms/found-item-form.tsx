      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
          >
            <h2 className="mb-1 text-xl font-bold text-gray-900 dark:text-gray-50">
              Found Something?
            </h2>
        ...
        {step === 1 && (
          ...
          >
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-brand-100 dark:bg-brand-900/50">
              <Sparkles className="h-8 w-8 animate-pulse text-brand-700 dark:text-brand-400" />
            </div>
        ...
        {step === 2 && (
          ...
          >
            <div className="mb-4 flex items-center gap-2">
              <button
                onClick={() => setStep(0)}
                className="rounded-lg p-1 text-gray-400 hover:bg-gray-100 dark:text-gray-500 dark:hover:bg-gray-800"
              >
                <ArrowLeft className="h-5 w-5" />
              </button>
              <div>
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50">Item Details</h2>
                {analysis && (
