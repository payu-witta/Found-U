...
const colorMap: Record<string, string> = {
  ...
  found: "bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300",
  active: "bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300",
  matched: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/50 dark:text-yellow-300",
  claimed: "bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300",
